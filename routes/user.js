...
const { saveRedirectUrl, isLoggedIn, isProfileOwner, validateUser, verifyEmail, verifyUserEmail } = require("../middleware");
...
router.post("/update-account/:id", isLoggedIn, isProfileOwner, verifyUserEmail, validateUser, wrapAsync(userController.updateAccount))  //update account------------
